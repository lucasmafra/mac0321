...
public class GhostPokemon extends Pokemon {
	...
	public GhostPokemon(String pokemonName, int maximumHp, PokemonAttack attacks[]) {
		...
		if (effectivenessMap.isEmpty()) {
			effectivenessMap.put(PokemonType.NORMAL, 	Effectiveness.NO_EFFECT.getValue());
			...
			effectivenessMap.put(PokemonType.PSYCHIC, 	Effectiveness.NO_EFFECT.getValue());
			...
			effectivenessMap.put(PokemonType.GHOST, 	Effectiveness.SUPER_EFFECTIVE.getValue());
